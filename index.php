         ...
         <div id="loader" class="th-preloader">
            <div class="animation-preloader">
               <div class="txt-loading">
                  ...
                  <span preloader-text="Y" class="characters">-</span>
                           ...
                           <div class="col-xl-7">
                              <div class="hero-style2">
                                 <h1 class="hero-title">
                                    ...
                                    Perfect Property with<br> SK ROY-L </span>
                                 </h1>
            ...
            <div class="row align-items-center flex-row-reverse">
               ...
               <div class="col-xl-5">
                  <div class="title-area mb-32">
                     ...
                     <p class="sec-text">We are a real estate firm dedicated to providing exceptional locations to our partners and clients. Within the luxury real estate market, our agency offers customized solutions tailored to meet individual needs. Our main goal is to deliver amazing properties and unparalleled service to ensure complete satisfaction for those we serve.                    
                  </div>
                  <div class="about-wrap2">
                     ...
                     <div class="call-btn">
                        ...
                        <div class="btn-content">
                           ...
                           <span class="btn-text"><a href="tel:9966778855">+91 9966778855</a></span>
                        </div>
                     </div>
                  </div>
                  <div class="btn-wrap mt-5">
                     <a href="about.php" class="th-btn style2 th-btn-icon">More About Us SK ROY-L</a>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row justify-content-between align-items-center">
               <div class="col-lg-6">
                  <div class="title-area">
                     ...
                     <p class="sec-text">Our real estate firm offers a comprehensive range of services designed to cater to the unique needs of our clients. </p>
                  </div>
               </div>
               <div class="col-auto">
                  <div class="sec-btn">
                     <a href="about.php" class="th-btn style2 th-btn-icon">Browse All Services</a>
                  </div>
               </div>
            </div>
               ...
               <div class="swiper-wrapper">
                  <div class="swiper-slide">
                     <div class="service-card style2">
                        ...
                        <p class="box-text">SK ROY-L services to facilitate the easy and confident purchase, sale, and management of your properties.</p>
                  ...
                  <div class="swiper-slide">
                     <div class="service-card style2">
                        ...
                        <h3 class="box-title"><a href="#">Property Management</a></h3>
                        <p class="box-text">SK ROY-L services to facilitate the easy and confident purchase, sale, and management of your properties.</p>
                        <div class="service-img img-shine">
                  ...
                  <div class="swiper-slide">
                     <div class="service-card style2">
                        ...
                        <h3 class="box-title"><a href="#">Invest Opportunities</a></h3>
                        <p class="box-text">SK ROY-L services to facilitate the easy and confident purchase, sale, and management of your properties.</p>
                        <div class="service-img img-shine">
            ...
            <div class="row justify-content-lg-between justify-content-center align-items-center">
               <div class="col-xxl-6 col-xl-7 col-lg-6">
                  <div class="title-area text-lg-start text-center">
                     <h2 class="sec-title text-white">See Our Latest Projects</h2>
                     <p class="sec-text text-white"> Each project includes an in-depth overview, detailed floor plans, and comprehensive site plans, highlighting the luxury finishes and sustainable design elements that set our properties apart. </p>
                  </div>
               </div>
               <div class="col-auto">
                  <div class="sec-btn">
                     <a href="about.php" class="th-btn style-border3 th-btn-icon">Browse All Project</a>
                  </div>
               </div>
            </div>
         </div>
                  ...
                  <div class="row justify-content-center">
                     <div class="col-lg-6 col-md-8 order-md-2">
                        <div class="title-area mb-md-0 text-center">
                           <h2 class="sec-title">Get In Touch Today </h2>
      ...
      <div class="space-bottom bg-title-dark overflow-hidden">
         ...
         <div class="container">
            <div class="row gx-60 align-items-center">
               <div class="col-lg-5">
                  <div class="appointment-thumb text-xl-end mb-lg-0 mb-50"><br><br>
               ...
               <div class="col-lg-7">
                  ...
                  <form action="https://html.themeholy.com/realar/demo/mail.php" method="POST" class="appointment-form ajax-contact me-xl-5">
                     <div class="row">
               ...
               <div class="col-lg-5">
                  ...
                  <div class="about-contact-grid">
                     ...
                     <div class="about-contact-details">
                        ...
                        <p class="about-contact-details-text">570001</p>
                     </div>
                  </div>
                  <div class="about-contact-grid">
                     <div class="about-contact-icon text-white">
                     ...
                     <div class="about-contact-details">
                        ...
                        <p class="about-contact-details-text"><a href="tel:001234567890">+91 9988776655</a></p>
                        <p class="about-contact-details-text"><a href="tel:001234567890">+91 9988776655</a></p>
                     </div>
                  </div>
                  <div class="about-contact-grid">
                     ...
                     <div class="about-contact-details">
                        ...
                        <p class="about-contact-details-text"><a href="mailto:infomailrealar@gmail.com">info@skrbd.com</a></p>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="swiper-wrapper">
                  <div class="col-auto swiper-slide">
                     <div class="insta-box">
                        ...
                        <a target="_blank" href="" class="icon-btn"></a>
                     </div>
                  </div>
                  <div class="col-auto swiper-slide">
                     <div class="insta-box">
